...
public final class LinphoneService extends Service implements
	...
	public void onCreate() {
		...
		Compatibility.setNotificationLatestEventInfo(mNotif, this,
				mNotificationTitle, "", mNotifContentIntent);
	...
	public void addNotification(Intent onClickIntent, int iconResourceID,
		...
		Compatibility.setNotificationLatestEventInfo(mCustomNotif, this, title,
				message, notifContentIntent);
	...
	private synchronized void sendNotification(int level, int textId) {
		...
		Compatibility.setNotificationLatestEventInfo(mNotif, this,
				mNotificationTitle, text, mNotifContentIntent);
